...
public class Connect {
    ...
    public static void main(String[] args){
        ...
        if(conexion != null)
            System.out.println("Conexion a Base de Datos Alumnos correcta!!! " + conexion);
        else
            System.out.println("Error en conexion a Base de Datos Alumnos!!!");
    }
